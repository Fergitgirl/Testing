...
public class SortTheOddTest {
    ...
    public void sortArray() {
        ...
        assertArrayEquals(outputA1, SortTheOdd.sortArray(inputA1));
        final int[] inputA2 = new int[]{5, 3, 1, 8, 0};
        final int[] outputA2 = new int[]{1, 3, 5, 8, 0};
        assertArrayEquals(outputA2, SortTheOdd.sortArray(inputA2));
        final int[] inputA3 = new int[]{};
        final int[] outputA3 = new int[]{};
        assertArrayEquals(outputA3, SortTheOdd.sortArray(inputA3));
    }
}
